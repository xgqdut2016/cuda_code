...
__global__ void matrixKernel4th(float *dA, float *dB, float *dC, int M, int K, int N)
{
    ...
    for (int ph = 1; ph < width; ph++)
    {
        ...
        for (int index_k = 0; index_k < BK; index_k++)
        {
            ...
            addSpecial(tmp[1], com_a[0].x, com_b[1]); // index_q = 0, 4<= index_v <= 7
            addSpecial(tmp[2], com_a[0].y, com_b[0]); // index_q = 1, 0<= index_v <= 3
            addSpecial(tmp[3], com_a[0].y, com_b[1]); // index_q = 1, 4<= index_v <= 7
            addSpecial(tmp[4], com_a[0].z, com_b[0]); // index_q = 2, 0<= index_v <= 3
            addSpecial(tmp[5], com_a[0].z, com_b[1]); // index_q = 2, 4<= index_v <= 7
            addSpecial(tmp[6], com_a[0].w, com_b[0]); // index_q = 3, 0<= index_v <= 3
            addSpecial(tmp[7], com_a[0].w, com_b[1]); // index_q = 3, 4<= index_v <= 7

            addSpecial(tmp[8], com_a[1].x, com_b[0]);  // index_q = 4, 0<= index_v <= 3
            addSpecial(tmp[9], com_a[1].x, com_b[1]);  // index_q = 4, 4<= index_v <= 7
            addSpecial(tmp[10], com_a[1].y, com_b[0]); // index_q =5, 0<= index_v <= 3
            addSpecial(tmp[11], com_a[1].y, com_b[1]); // index_q = 5, 4<= index_v <= 7
            addSpecial(tmp[12], com_a[1].z, com_b[0]); // index_q = 6, 0<= index_v <= 3
            addSpecial(tmp[13], com_a[1].z, com_b[1]); // index_q = 6, 4<= index_v <= 7
            addSpecial(tmp[14], com_a[1].w, com_b[0]); // index_q =7, 0<= index_v <= 3
            addSpecial(tmp[15], com_a[1].w, com_b[1]); // index_q = 7, 4<= index_v <= 7
        }
